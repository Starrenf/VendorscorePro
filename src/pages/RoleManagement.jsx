...
const ROLE_TEMPLATES = [
  {
    name: "Super Admin",
    description: "Volledig beheer van VendorScorePro, inclusief instellingen, rollen en gevoelige configuratie.",
    risk: "hoog",
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-700">
              Beheer wie welke rol krijgt binnen VendorScorePro. Deze release legt het fundament voor echte rolgebaseerde toegang. Menu-filtering en RLS-koppeling volgen gefaseerd, zodat we veilig kunnen testen zonder bestaande modules te breken.
            </p>
          </div>
