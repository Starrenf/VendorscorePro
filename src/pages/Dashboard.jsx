    ...
    async function run() {
      ...
      try {
        ...
        const [{ data: apps }, { data: assignments }] = await Promise.all([
          client
            .from("applications")
            .select("id,organization_id,supplier_id,name,description,is_active,is_critical,functional_owner")
          ...
          client
            ...
            .select("supplier_id,application_id,application_name,contact_name,email,role_title,is_primary")
