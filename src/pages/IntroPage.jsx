  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm">
        <div className="text-sm uppercase tracking-[0.2em] text-white/70">Waarom Governix</div>
        ...
        <p className="mt-4 max-w-3xl text-white/85 leading-7">
          Veel organisaties beheren contracten, maar missen direct inzicht in governance status, leveranciersrisico’s en prestaties. Governix maakt dat overzicht concreet, visueel en bestuurlijk bespreekbaar.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 text-white/90">
          <h2 className="text-xl font-semibold text-white">Wat doet Governix?</h2>
          <ul className="mt-3 space-y-2 leading-7 list-disc pl-5">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6 text-white/90">
          <h2 className="text-xl font-semibold text-white">Waarom geschikt voor management en governance?</h2>
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6 text-white/90">
        ...
        <p className="mt-2 leading-7">
          Governix is ontstaan vanuit de praktijkbehoefte om leveranciersbeoordeling, governance en opvolging samen te brengen in één bruikbaar werkoverzicht.
        </p>
      </div>
    </div>
  );
