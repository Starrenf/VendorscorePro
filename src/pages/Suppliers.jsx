  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      const cleaned = list.map((row) => ({
        ...row,
        classification: row.classification || row.strategic_type || row.supplier_type || "Onbekend",
        domain: row.domain || row.category || "generiek",
        category: row.category || "Niet ingevuld",
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2 text-sm text-slate-600">
                    ...
                    <span className="badge">
                      Domein {supplierDomainLabel(s.domain || s.category)}
                    </span>
                    <span className="badge">
