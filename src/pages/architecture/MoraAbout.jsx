  ...
  return (
    <div className="space-y-6">
      <div className="arch-hero">
        <div className="arch-hero-brand">
          ...
          <div>
            ...
            <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-white md:text-4xl">MORA in VendorScorePro</h1>
            <p className="mt-2 max-w-3xl text-sm leading-relaxed text-white/78">MORA helpt om onderwijsprocessen, applicaties, informatievoorziening en ketens gestructureerd inzichtelijk te maken. VendorScorePro gebruikt deze laag om governance en leveranciersrisico te verbinden met architectuurimpact.</p>
          </div>
        </div>
      ...
      <div className="card p-6">
        ...
        <div className="mt-5 grid gap-3 md:grid-cols-5">
          {[
            ...
            ["Applicaties", "VendorScorePro data"],
      ...
      <div className="card p-5 bg-slate-50">
        ...
        <p className="mt-1 text-sm text-slate-600">Plaats het officiële MORA-logo later in <code>public/architecture/mora-logo.png</code>. Tot die tijd toont VendorScorePro automatisch een nette placeholder.</p>
      </div>
    </div>
  );
}
