...
export default function ArchitectView() {
  ...
  const resultConfig = {
    gaps: {
      ...
      description: "MORA-componenten die niet sterk gekoppeld zijn aan VendorScorePro, met eventuele relatie-impact.",
    ...
    coverage: {
      ...
      description: "Exacte en sterke matches tussen MORA en VendorScorePro.",
      rows: model.usefulMatches,
      columns: [
        { key: "mora_application_name", label: "MORA" },
        { key: "vendorscore_application_name", label: "VendorScorePro", render: (r) => <span className="font-semibold text-blue-700">{r.vendorscore_application_name}</span> },
    ...
    candidates: {
      ...
      columns: [
        { key: "mora_application_name", label: "MORA" },
        { key: "vendorscore_application_name", label: "Kandidaat" },
        { key: "match_score", label: "Score", render: (r) => <span className={`arch-domain-badge arch-domain-${scoreTone(Number(r.match_score || 0))}`}>{r.match_score}%</span> },
    ...
    dataquality: {
      title: "Datakwaliteit VendorScorePro",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1.2fr)_minmax(360px,.8fr)]">
        <div className="card p-5">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <MiniProgress label="VendorScore apps met MORA" value={linkedApps} total={applications.length || 1} tone="green" />
      ...
      <div className="arch-tile-grid">
        ...
        <ArchitectTile icon={CheckCircle2} label="Dekking" value={`${linkedApps}/${applications.length || 0}`} subtext="Gekoppelde VendorScore apps" tone="green" active={selectedView === "coverage"} onClick={() => setSelectedView("coverage")} />
          ...
          <div className="card p-5 bg-amber-50 border-amber-100">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-amber-900/85">Een MORA-component zonder VendorScore-koppeling is niet direct fout, maar wel een signaal: registreren als applicatie, markeren als technisch component, uitsluiten of koppelen.</p>
              </div>
            </div>
          </div>
        </div>
