...
export default function ArchitectureCockpit() {
  ...
  const selections = useMemo(() => ({
    linked: {
      ...
      description: "Exacte en sterke MORA-koppelingen richting Governix applicaties.",
      rows: model.usefulMatches,
      columns: [
        { key: "mora_application_name", label: "MORA component" },
        { key: "governix_application_name", label: "Governix applicatie", render: (r) => <span className="font-semibold text-blue-700">{r.governix_application_name}</span> },
    ...
    candidates: {
      ...
      columns: [
        { key: "mora_application_name", label: "MORA component" },
        { key: "governix_application_name", label: "Kandidaat applicatie" },
        { key: "match_score", label: "Score", render: (r) => <span className="badge">{r.match_score}%</span> },
    ...
    unlinkedApps: {
      id: "unlinkedApps",
      title: "Governix applicaties zonder MORA-koppeling",
    ...
    unlinkedMora: {
      ...
      description: "Architectuurcomponenten die nog niet zichtbaar gekoppeld zijn aan Governix applicaties.",
    ...
    duplicates: {
      ...
      description: "Datakwaliteit: gelijke of zeer vergelijkbare applicatienamen in Governix.",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="arch-tile-grid">
        <Tile id="linked" icon={CheckCircle2} label="Gekoppelde applicaties" value={`${linkedApps}/${totalApps}`} subtext="Governix apps met MORA-match" tone="green" active={selectedId === "linked"} onClick={setSelectedId} />
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ol className="mt-3 space-y-2 text-sm text-slate-700">
                  ...
                  <li>2. Koppel {model.unlinkedApps.length} Governix applicaties handmatig.</li>
