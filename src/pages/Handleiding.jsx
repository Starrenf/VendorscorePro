    ...
    <div className="mx-auto max-w-4xl space-y-6">
      <section className="card p-6">
        ...
        <p className="mt-3 text-base leading-7 text-slate-700">
          Gebruik deze stappen als je voor het eerst inlogt in Governix. Nieuwe gebruikers worden niet automatisch aan een organisatie gekoppeld.
          Eerst maak je zelf een account aan. Daarna stuur je een e-mail naar Frank zodat je aan de juiste organisatie gekoppeld kunt worden.
        </p>
        <div className="mt-5 flex flex-wrap gap-3">
          <a
            href="/docs/Governix_Handleiding_Nieuwe_Gebruikers.docx"
          ...
          <a
            href="mailto:f.starren@rocgilde.nl?subject=Aanvraag%20toegang%20Governix%20Pro"
            className="btn"
          >
      ...
      <section className="card p-6 space-y-5">
        <div>
          ...
          <ol className="mt-2 list-decimal pl-5 space-y-2 text-slate-700 leading-7">
            <li>Open Governix en kies <b>Account aanmaken</b>.</li>
        ...
        <div>
          ...
          <p className="mt-2 text-slate-700 leading-7">
            Na het aanmaken van je account stuur je een e-mail naar Frank Starren. Vermeld daarin aan welke organisatie je gekoppeld moet worden.
          </p>
          <div className="mt-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
            ...
            <div className="mt-2 font-mono text-xs leading-6">
              Onderwerp: Aanvraag toegang Governix
              <br />
              Beste Frank,
              <br />
              Ik heb een account aangemaakt in Governix.
              <br />
              Graag wil ik gekoppeld worden aan: [naam organisatie].
              <br />
