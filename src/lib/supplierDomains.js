export const SUPPLIER_DOMAIN_OPTIONS = [
  ...
  { value: 'clustersoftware', label: 'Clustersoftware' },
...
export function normalizeSupplierDomain(value) {
  ...
  if (['clustersoftware', 'cluster software', 'onderwijsapplicatie', 'onderwijssoftware'].includes(raw)) return 'clustersoftware';
