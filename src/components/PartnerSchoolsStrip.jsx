...
const SCHOOLS = [
  { name: "Gilde Opleidingen", slug: "gildeopleidingen" },
      ...
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          <h2 className="text-xl font-semibold text-slate-900">
            MBO pilotinstellingen
          </h2>
          <p className="mt-1 text-sm text-slate-600 max-w-3xl">
            VendorScore Pro wordt in deze fase gebruikt en getest door meerdere
            mbo-scholen. Hieronder staan de deelnemende instellingen als visuele
            schoolkaarten.
          </p>
        </div>
        {!compact ? (
          <Link className="btn" to="/handleiding">
            Lees de handleiding
          </Link>
        ) : null}
      </div>
          ...
          >
            <img
              ...
              onError={(e) => {
                ...
                e.currentTarget.src = `/logos/schools/${school.slug}.jpg`;
              }}
            />
          </div>
        ))}
