      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="mt-1 max-w-3xl text-sm leading-6 text-slate-600">
            Snelstart naar de kritische applicaties van Gilde. De documenten, contracten en governance blijven in VendorScorePro; de tegel opent de bijbehorende applicatie of website.
          </p>
        </div>
