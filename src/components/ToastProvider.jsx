...
export function ToastProvider({ children }) {
  ...
  const push = useCallback((tone, message, title, options = {}) => {
  ...
  const api = useMemo(() => ({
    success: (message, title = "Gelukt", options) => push("success", message, title, options),
    error: (message, title = "Fout", options) => push("danger", message, title, options),
    info: (message, title = "Info", options) => push("info", message, title, options),
