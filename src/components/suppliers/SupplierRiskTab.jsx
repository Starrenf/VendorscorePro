...
export default function SupplierRiskTab({ supplier, organization }) {
  ...
  async function handleSave() {
    try {
      ...
      const saved = await saveWithToast(() => saveSupplierRiskProfile(payload), toast, {
        loading: "Risicoprofiel opslaan...",
        success: "Risicoprofiel opgeslagen.",
        error: "Opslaan risicoprofiel mislukt.",
      });
      setSavedRisk(saved);
    } catch (err) {
