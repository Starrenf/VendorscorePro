  ...
  return (
    <div className="max-w-5xl space-y-4">
      <div className="flex items-start justify-between gap-3 flex-wrap">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1">
            Registreer alleen links naar Teams/SharePoint. Governix slaat geen Gilde-documenten extern op.
          </p>
        </div>
      ...
      <Notice title="Veilige documentregistratie" tone="info">
        Het bronbestand blijft op de Gilde Teams/SharePoint-locatie staan. In Governix worden alleen metadata en de verwijzing opgeslagen.
      </Notice>
